A simple easy to read on screen LaTeX template for preprint.

Useful to publish on platform like arXiv.
The template is based on the Springer Computer Science Proceedings 
